...
//             validators={{
//               onChange: ({ value }) =>
//                 !value ? "A first name is required" : value.length < 3 ? "First name must be at least 3 characters" : undefined,
...
// Validation will not provide you with transformed values. See submission handling for more information.
